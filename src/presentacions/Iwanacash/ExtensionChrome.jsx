	...
	return (
		<Layout>
				...
				<div className="col-12 col-main mb-5">
					<section className="store-detail">
						<div className="store-header">
							<p className="title-h2 title-store">Nuestra Extensión</p>
							<p className="store-h4 mt-4">Instala nuestra extensión en tu navegador y comienza a ganar dinero en tus compras diarias.</p>
			...
			<div className="row row-extension">
				<div className="col-12">
					<div className="container extension-panel">
				...
				<div className="col-12">
					<div className="container extension-cashback">
						<section className="work-main text-md-right pl-md-5">
							<div className="clic-title ext-clic-title mt-4">
								<p>Activa tu cashback</p>
							</div>
							<div>
								<p className="store-h4 text-right mt-4 mb-0">Cientos de tiendas disponibles.</p>
								<p className="extension-h4 text-right">La instalación es rápida, sencilla y confiable. En tan solo 1 minuto puedes instalar la extensión para Chrome y así podrás activar el cashback directamente en cada tienda, sin necesidad de pasar por la plataforma iwanacash.com</p>
							</div>
						</section>
						<section className="work-secondary">
							<div className="extension-image">
				...
				<div className="col-12 mb-5 pb-5">
					<section className="text-center row-extension-money">
